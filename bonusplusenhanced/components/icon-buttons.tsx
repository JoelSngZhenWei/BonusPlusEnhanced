      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <button 
            ...
            className={`p-2 ${isDark ? 'text-black' : 'text-white'} hover:opacity-70 transition-opacity clickable relative highlight-glow ${isOpen ? 'z-50' : ''}`}
          >
        ...
        <PopoverContent className="w-80 mr-6 z-50">
