...
export function BonusPlusAccount() {
  ...
  const transactions = [
    { date: "2024-10-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    ...
    { date: "2024-09-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2024-08-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2024-07-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2024-06-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2024-05-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    ...
    { date: "2024-04-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2024-03-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2024-02-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    ...
    { date: "2024-01-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2023-12-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
    { date: "2023-11-25", desc: "Salary Credit", amount: 550, type: "credit", from: "ACME Corp", to: "BonusMax Account", status: "approved" },
  ]
                    ...
                    <Dialog key={index}>
                      <DialogTrigger asChild>
                        <div className="flex justify-between items-center py-2 border-b last:border-0 cursor-pointer hover:bg-gray-50">
                          <div>
                            <div className="text-sm text-gray-600">{format(new Date(transaction.date), "dd MMM")}</div>
